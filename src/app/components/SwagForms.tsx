...
export default function SwagForms() {
    ...
    async function handleFormSubmit(e:any) {
        ...
        if (code)                 return router.push("/checkout/swags/sucess");
    ...
    return (
        <section className="max-w-xl p-4 mx-auto  rounded-md shadow-md bg-gray-800 ">
            <div className="flex items-center justify-center mt-12">
                <Image className="rounded-2xl" src="/PolkaBlockchain.png" alt="logotipo da comunidade Polkadot Brasil na Smart City" width={600} height={600}/>
            </div>
                    ...
                    <div className="sm:col-span-2">
                        <div className="flex items-center">
                            ...
                            <label htmlFor="newsletter" className="ml-2 text-sm text-white">
                                Sim, quero receber novidades da Polkadot.
                            </label>
                        </div>
                    </div>
