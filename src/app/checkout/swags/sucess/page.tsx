    ...
    return (
        <Area className="bg-background-secondary h-screen ">
            <div className="flex flex-col items-center justify-center  ">
                ...
                <Image className="mt-8" src="/PolkaBlockchain.png" alt="logotipo da comunidade Polkadot Brasil" width={500} height={500} />
                <h1 className=" font-bold mt-12 font-title text-polkadot-rose md:text-4xl">POLKADOT BRASIL</h1>
            </div>
